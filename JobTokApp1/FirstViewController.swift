...
class FirstViewController: UIViewController,UITabBarDelegate,UITextViewDelegate, SideMenuDelegate {
    var player:AVPlayer!
    ...
    override func viewDidLoad() {
        ...
        sideView = SideCommentMenu(image:imageArray, parentViewController:self)
 ...
 */
    ...
    */
        ...
        let path = Bundle.main.path(forResource: "movie2", ofType: "mp4")!
        // 生成
   ...
   //タブバーを押すと呼ばれる
    ...
    @objc func upViewDidAppear(_ animated: Bool) {
        ...
        let firstView:UIViewController =  FirstView4Controller()
        let secondView:UIViewController =  SecondViewController()
        let thirdView:UIViewController = ThirdViewController()
