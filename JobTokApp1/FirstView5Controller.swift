...
class FirstView5Controller: UIViewController,UITabBarDelegate,UITextViewDelegate, SideMenuDelegate {
    var player:AVPlayer!
 ...
 */
    ...
    */
        ...
        let path = Bundle.main.path(forResource: "movie1", ofType: "mp4")!
        // 生成
