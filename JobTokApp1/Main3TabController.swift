...
class Main3TabController: UITabBarController {
    required init?(coder aDecoder: NSCoder) {
        ...
        let first3ViewController = First3ViewController()
        first3ViewController.tabBarItem = UITabBarItem(tabBarSystemItem: UITabBarItem.SystemItem.downloads, tag: 0)
        viewControllers.append(first3ViewController)
